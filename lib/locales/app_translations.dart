...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      AppLocales.auth.shared.sessionExpired: 'Your session has expired. Please sign in again.',
      AppLocales.auth.shared.sessionReplaced: 'Your session was replaced by a newer sign in on this platform.',

      // Auth Initial
      AppLocales.auth.initial.title: '✨ Welcome to Rexone ✨',
      AppLocales.auth.initial.subtitle: 'Support dreams or make yours come true',
      AppLocales.auth.initial.continueWithGoogle: 'Continue with Google',
      AppLocales.auth.initial.or: 'or',
      AppLocales.auth.initial.emailHelper: 'Enter your email to sign in or create an account',
      AppLocales.auth.initial.invalidEmail: 'Please enter a valid email address. (e.g. example@domain.com)',
      AppLocales.auth.initial.checking: 'Checking...',
      AppLocales.auth.initial.googleFailure: 'Google authentication failed!',
      AppLocales.auth.initial.googleTooManyAttempts: 'Too many attempts. Please wait @seconds seconds and try again.',
      AppLocales.auth.initial.connectionFailed: 'Connection failed. Please try again.',
      ...
      AppLocales.auth.signInPasscode.subtitle: 'Enter your 6-digit passcode for @email',
      AppLocales.auth.signInPasscode.passcodeLabel: 'Passcode',
      AppLocales.auth.signInPasscode.signingIn: 'Signing in...',
      AppLocales.auth.signInPasscode.forgotPasscodeLink: 'Forgot your passcode?',
      AppLocales.auth.signInPasscode.passcode6Digits: 'Please enter 6-digit passcode',
      AppLocales.auth.signInPasscode.attemptsRemaining: 'Attempts remaining before cooldown: @left/@total',
      AppLocales.auth.signInPasscode.cooldownMessage: 'Too many incorrect passcode attempts. Please wait @seconds seconds.',
      AppLocales.auth.signInPasscode.tryAgainIn: 'Try again in @seconds⁠s',
      AppLocales.auth.signInPasscode.signInFailed: 'Sign in failed. Please try again.',
      ...
      AppLocales.auth.signUpPasscodeCreate.subtitle: "You'll use this 6-digit passcode to sign in",
      AppLocales.auth.signUpPasscodeCreate.googleHeading: 'One last step',
      AppLocales.auth.signUpPasscodeCreate.googleSubtitle: 'Create and confirm a passcode to finish Google sign up',
      AppLocales.auth.signUpPasscodeCreate.instruction: 'This will be used to quickly sign in to your account.',
      ...
      AppLocales.auth.signUpPasscodeConfirm.subtitle: 'Please confirm your passcode.',
      ...
      AppLocales.auth.signUpPasscodeConfirm.passcodesMismatch: 'Passcodes do not match',
      ...
      AppLocales.auth.signUpInfo.usernameMinLength: 'Username must be at least 3 characters',
      AppLocales.auth.signUpInfo.usernameCharset: 'Username can only contain letters, numbers, and underscores',
      ...
      AppLocales.auth.confirmEmail.sendCodeFailed: 'Failed to send verification code',

      // Auth Forgot Passcode
      AppLocales.auth.forgotPasscode.title: 'Forgot Passcode',
      AppLocales.auth.forgotPasscode.subtitle: 'Enter your email and we will send you a link to reset your passcode.',
      ...
      AppLocales.auth.forgotPasscode.resetFailed: 'Failed to send reset instructions',
      ...
      AppLocales.setting.logoutConfirmation: 'Are you sure you want to sign out?',
      ...
      AppLocales.setting.clearHistoryConfirmMsg: 'All messages in this conversation will be permanently deleted.',
      AppLocales.setting.deleteRoomTitle: 'Delete Room',
      AppLocales.setting.deleteRoomConfirmMsg: 'This room and all its messages will be permanently deleted.',
      AppLocales.setting.cancelSubTitle: 'Cancel Subscription',
      AppLocales.setting.cancelSubConfirmMsg: 'Your subscription will remain active until the end of the billing period.',
      ...
      AppLocales.feedback.description: 'We value your thoughts and ideas to help improve Rexone.',
      AppLocales.feedback.rateExperience: 'Rate your experience (1 - 10)',
      AppLocales.feedback.tellUsMore: "What's on your mind?",
      AppLocales.feedback.placeholder: 'Tell us anything — bugs, suggestions, questions, or ideas. We triage automatically!',
      ...
      AppLocales.payment.successDesc: 'Your payment has been processed and your features are active.',
      AppLocales.payment.cancelTitle: 'Payment Canceled',
      AppLocales.payment.cancelDesc: 'Your payment was canceled. No charges were made.',

      // User
      AppLocales.user.profile: 'User Profile',
      AppLocales.user.changeAvatar: 'Change Avatar',
      AppLocales.user.avatarHint: 'Upload a new profile picture (PNG, JPG, WebP supported)',
    ...
    'my_MM': {
      ...
      AppLocales.auth.shared.passcodeLength: 'ဂဏန်း ၆ လုံး လျှို့ဝှက်ကုဒ် ထည့်ပါ',
      AppLocales.auth.shared.sessionExpired: 'သင့် Session သက်တမ်းကုန်သွားပါပြီ။ ကျေးဇူးပြု၍ ပြန်လည်ဝင်ရောက်ပါ။',
      AppLocales.auth.shared.sessionReplaced: 'ဤစက်ပေါ်တွင် နောက်ဆုံးလော့ဂ်အင်ဝင်မှုကြောင့် သင့် session အသစ်ဖြင့် အစားထိုးခံရပါသည်။',

      // Auth Initial
      AppLocales.auth.initial.title: '✨ Rexone မှ ကြိုဆိုပါတယ် ✨',
      AppLocales.auth.initial.subtitle: 'အိပ်မက်များကို ပံ့ပိုးပါ သို့မဟုတ် သင့်အိပ်မက်ကို အကောင်အထည်ဖော်ပါ',
      AppLocales.auth.initial.continueWithGoogle: 'Google ဖြင့် ဆက်လက်လုပ်ဆောင်ရန်',
      AppLocales.auth.initial.or: 'သို့မဟုတ်',
      AppLocales.auth.initial.emailHelper: 'လော့ဂ်အင်ဝင်ရန် သို့မဟုတ် အကောင့်ဖွင့်ရန် အီးမေးလ်ထည့်ပါ',
      AppLocales.auth.initial.invalidEmail: 'မှန်ကန်သော အီးမေးလ်လိပ်စာ ထည့်ပါ။ (ဥပမာ example@domain.com)',
      AppLocales.auth.initial.checking: 'စစ်ဆေးနေသည်...',
      AppLocales.auth.initial.googleFailure: 'Google အတည်ပြုမှု မအောင်မြင်ပါ!',
      AppLocales.auth.initial.googleTooManyAttempts: 'ကြိုးစားမှုများလွန်းပါသည်။ @seconds စက္ကန့် စောင့်ပြီး ထပ်စမ်းပါ။',
      AppLocales.auth.initial.connectionFailed: 'ချိတ်ဆက်မှု မအောင်မြင်ပါ။ ထပ်စမ်းကြည့်ပါ။',
      ...
      AppLocales.auth.signInPasscode.subtitle: '@email အတွက် ဂဏန်း ၆ လုံး လျှို့ဝှက်ကုဒ်ထည့်ပါ',
      AppLocales.auth.signInPasscode.passcodeLabel: 'လျှို့ဝှက်ကုဒ်',
      AppLocales.auth.signInPasscode.signingIn: 'လော့ဂ်အင်ဝင်နေသည်...',
      AppLocales.auth.signInPasscode.forgotPasscodeLink: 'လျှို့ဝှက်ကုဒ် မေ့သွားပြီလား?',
      AppLocales.auth.signInPasscode.passcode6Digits: 'ဂဏန်း ၆ လုံး လျှို့ဝှက်ကုဒ် ထည့်ပါ',
      AppLocales.auth.signInPasscode.attemptsRemaining: 'ခဏရပ်နားချိန်မတိုင်မီ ကျန်ကြိုးစားခွင့်: @left/@total',
      AppLocales.auth.signInPasscode.cooldownMessage: 'လျှို့ဝှက်ကုဒ် အမှားများလွန်းပါသည်။ @seconds စက္ကန့် စောင့်ပါ။',
      AppLocales.auth.signInPasscode.tryAgainIn: '@seconds⁠s အတွင်း ပြန်စမ်းပါ',
      AppLocales.auth.signInPasscode.signInFailed: 'လော့ဂ်အင် မအောင်မြင်ပါ။ ထပ်စမ်းကြည့်ပါ။',
      ...
      AppLocales.auth.signUpPasscodeCreate.subtitle: 'လော့ဂ်အင်ဝင်ရန် ဤဂဏန်း ၆ လုံး လျှို့ဝှက်ကုဒ်ကို သုံးပါမည်',
      AppLocales.auth.signUpPasscodeCreate.googleHeading: 'နောက်ဆုံးအဆင့်',
      AppLocales.auth.signUpPasscodeCreate.googleSubtitle: 'Google အကောင့်ဖွင့်ခြင်း ပြီးမြောက်ရန် လျှို့ဝှက်ကုဒ် သတ်မှတ်ပြီး အတည်ပြုပါ',
      AppLocales.auth.signUpPasscodeCreate.instruction: 'အကောင့်သို့ အမြန်လော့ဂ်အင်ဝင်ရန် ဤကုဒ်ကို သုံးပါမည်။',

      // Auth SignUp Passcode Confirm
      AppLocales.auth.signUpPasscodeConfirm.title: 'လျှို့ဝှက်ကုဒ် အတည်ပြုရန်',
      AppLocales.auth.signUpPasscodeConfirm.heading: 'လျှို့ဝှက်ကုဒ် အတည်ပြုရန်',
      AppLocales.auth.signUpPasscodeConfirm.subtitle: 'ကျေးဇူးပြု၍ သင့်ကုဒ်ကို အတည်ပြုပါ။',
      ...
      AppLocales.auth.signUpPasscodeConfirm.passcodesMismatch: 'လျှို့ဝှက်ကုဒ်များ မကိုက်ညီပါ',
      ...
      AppLocales.auth.signUpInfo.usernameMinLength: 'အသုံးပြုသူအမည်သည် အနည်းဆုံး စာလုံး ၃ လုံး ရှိရမည်',
      AppLocales.auth.signUpInfo.usernameCharset: 'အသုံးပြုသူအမည်တွင် စာလုံး၊ ဂဏန်းနှင့် underscore များသာ ပါဝင်နိုင်သည်',
      AppLocales.auth.signUpInfo.registrationFailed: 'အကောင့်ဖွင့်ခြင်း မအောင်မြင်ပါ',
      ...
      AppLocales.auth.confirmEmail.resendCodeIn: '@seconds⁠s အတွင်း ကုဒ်ပြန်ပို့နိုင်သည်',
      ...
      AppLocales.auth.forgotPasscode.subtitle: 'အီးမေးလ်ထည့်ပါ။ လျှို့ဝှက်ကုဒ် ပြန်သတ်မှတ်ရန် လင့်ခ် ပို့ပေးပါမည်။',
      AppLocales.auth.forgotPasscode.sendResetLink: 'ပြန်သတ်မှတ်ရန် လင့်ခ် ပို့ရန်',
      AppLocales.auth.forgotPasscode.sending: 'ပို့နေသည်...',
      AppLocales.auth.forgotPasscode.backToSignIn: 'လော့ဂ်အင်သို့ ပြန်သွားရန်',
      AppLocales.auth.forgotPasscode.resetFailed: 'ပြန်သတ်မှတ်ရန် ညွှန်ကြားချက် ပို့၍မရပါ',
      ...
      AppLocales.setting.clearHistoryConfirmMsg: 'ဤစကားဝိုင်းရှိ မက်ဆေ့ဂျ်များ အားလုံး အပြီးအပိုင် ဖျက်မည်။',
      AppLocales.setting.deleteRoomTitle: 'အခန်းဖျက်ရန်',
      AppLocales.setting.deleteRoomConfirmMsg: 'ဤအခန်းနှင့် မက်ဆေ့ဂျ်များ အားလုံး အပြီးအပိုင် ဖျက်မည်။',
      AppLocales.setting.cancelSubTitle: 'စာရင်းသွင်းမှု ပယ်ဖျက်ရန်',
      AppLocales.setting.cancelSubConfirmMsg: 'ငွေပေးချေမှု ကာလကုန်သည်အထိ သင့်စာရင်းသွင်းမှု ဆက်လက် အသုံးပြုနိုင်မည်။',
      ...
      AppLocales.feedback.description: 'Rexone ပိုမိုကောင်းမွန်စေရန် သင့်အကြံပြုချက်များကို တန်ဖိုးထားပါသည်။',
      AppLocales.feedback.rateExperience: 'သင့်အတွေ့အကြုံကို အဆင့်သတ်မှတ်ပါ (၁ - ၁၀)',
      AppLocales.feedback.tellUsMore: 'သင့်စိတ်ထဲမှာ ဘာရှိပါသလဲ?',
      AppLocales.feedback.placeholder: 'ချို့ယွင်းချက်၊ အကြံပြုချက်၊ မေးခွန်း သို့မဟုတ် အကြံဥာဏ်များကို ရေးသားနိုင်ပါသည်။',
      AppLocales.feedback.submit: 'အကြံပြုချက် ပို့မည်',
      AppLocales.feedback.submitting: 'ပို့နေသည်...',
      AppLocales.feedback.successMessage: 'သင့်အကြံပြုချက်အတွက် ကျေးဇူးတင်ပါသည်!',
      ...
      AppLocales.payment.successDesc: 'သင့်ငွေပေးချေမှု ပြီးမြောက်ပြီး ဝန်ဆောင်မှုများ စတင်အသုံးပြုနိုင်ပါပြီ။',
      AppLocales.payment.cancelTitle: 'ငွေပေးချေမှု ပယ်ဖျက်ထားသည်',
      AppLocales.payment.cancelDesc: 'သင့်ငွေပေးချေမှုကို ပယ်ဖျက်လိုက်ပါသည်။ မည်သည့်ငွေမှ ကောက်ခံထားခြင်းမရှိပါ။',
