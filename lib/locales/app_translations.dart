...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      Constants.locale.confirmDelete: 'Delete',
      Constants.locale.confirmClear: 'Clear',
      Constants.locale.clearHistoryTitle: 'Clear History',
      Constants.locale.clearHistoryConfirmMsg: 'All messages in this conversation will be permanently deleted.',
      Constants.locale.deleteRoomTitle: 'Delete Room',
      Constants.locale.deleteRoomConfirmMsg: 'This room and all its messages will be permanently deleted.',
      Constants.locale.cancelSubTitle: 'Cancel Subscription',
      Constants.locale.cancelSubConfirmMsg: 'Your subscription will remain active until the end of the billing period.',
      Constants.locale.micPermissionTitle: 'Microphone access required',
      Constants.locale.micPermissionMessage:
          'Voice input needs microphone access. Open Settings to enable it for this app.',
      Constants.locale.openSettings: 'Open Settings',
      Constants.locale.aiSendMessageFailed: 'Failed to send message',
      Constants.locale.aiResponseFailed: 'Failed to get AI response',
      Constants.locale.aiHistoryCleared: 'Chat history cleared',
      Constants.locale.aiClearHistoryFailed: 'Failed to clear history',
      Constants.locale.aiStartRecordingFailed: 'Failed to start recording',
      Constants.locale.aiSaveRecordingFailed: 'Failed to save recording',
      Constants.locale.aiTranscriptionFailed: 'Failed to transcribe audio',
      Constants.locale.aiTranscriptionEmpty: 'No speech detected. Try again.',
      Constants.locale.aiTranscribing: 'Transcribing...',
      Constants.locale.aiTtsFailed: 'Failed to play speech',
      Constants.locale.aiTtsEmpty: 'Nothing to speak',
    },
    'es_ES': {
      ...
      Constants.locale.confirmDelete: 'Eliminar',
      Constants.locale.confirmClear: 'Borrar',
      Constants.locale.clearHistoryTitle: 'Borrar historial',
      Constants.locale.clearHistoryConfirmMsg: 'Todos los mensajes de esta conversación serán eliminados permanentemente.',
      Constants.locale.deleteRoomTitle: 'Eliminar sala',
      Constants.locale.deleteRoomConfirmMsg: 'Esta sala y todos sus mensajes serán eliminados permanentemente.',
      Constants.locale.cancelSubTitle: 'Cancelar suscripción',
      Constants.locale.cancelSubConfirmMsg: 'Tu suscripción seguirá activa hasta el final del período de facturación.',
      Constants.locale.micPermissionTitle: 'Se requiere acceso al micrófono',
      Constants.locale.micPermissionMessage:
          'La entrada de voz necesita acceso al micrófono. Abre Ajustes para habilitarlo en esta app.',
      Constants.locale.openSettings: 'Abrir ajustes',
      Constants.locale.aiSendMessageFailed: 'No se pudo enviar el mensaje',
      Constants.locale.aiResponseFailed: 'No se pudo obtener la respuesta de la IA',
      Constants.locale.aiHistoryCleared: 'Historial de chat borrado',
      Constants.locale.aiClearHistoryFailed: 'No se pudo borrar el historial',
      Constants.locale.aiStartRecordingFailed: 'No se pudo iniciar la grabación',
      Constants.locale.aiSaveRecordingFailed: 'No se pudo guardar la grabación',
      Constants.locale.aiTranscriptionFailed: 'No se pudo transcribir el audio',
      Constants.locale.aiTranscriptionEmpty:
          'No se detectó voz. Inténtalo de nuevo.',
      Constants.locale.aiTranscribing: 'Transcribiendo...',
      Constants.locale.aiTtsFailed: 'No se pudo reproducir el audio',
      Constants.locale.aiTtsEmpty: 'Nada que reproducir',
    },
    'my_MM': {
      ...
      Constants.locale.confirmDelete: 'ဖျက်မည်',
      Constants.locale.confirmClear: 'ရှင်းလင်းမည်',
      Constants.locale.clearHistoryTitle: 'မှတ်တမ်းရှင်းလင်းရန်',
      Constants.locale.clearHistoryConfirmMsg: 'ဤစကားဝိုင်းရှိ မက်ဆေ့ဂျ်များ အားလုံး အပြီးအပိုင် ဖျက်မည်။',
      Constants.locale.deleteRoomTitle: 'အခန်းဖျက်ရန်',
      Constants.locale.deleteRoomConfirmMsg: 'ဤအခန်းနှင့် မက်ဆေ့ဂျ်များ အားလုံး အပြီးအပိုင် ဖျက်မည်။',
      Constants.locale.cancelSubTitle: 'စာရင်းသွင်းမှု ပယ်ဖျက်ရန်',
      Constants.locale.cancelSubConfirmMsg: 'ငွေပေးချေမှု ကာလကုန်သည်အထိ သင့်စာရင်းသွင်းမှု ဆက်လက် အသုံးပြုနိုင်မည်။',
      Constants.locale.micPermissionTitle: 'မိုက်ခရိုဖုန်း ခွင့်ပြုချက် လိုအပ်သည်',
      Constants.locale.micPermissionMessage:
          'အသံဖြင့် ရိုက်ထည့်ရန် မိုက်ခရိုဖုန်း ခွင့်ပြုချက် လိုအပ်ပါသည်။ Settings မှ ဖွင့်ပေးပါ။',
      Constants.locale.openSettings: 'Settings ဖွင့်ရန်',
      Constants.locale.aiSendMessageFailed: 'မက်ဆေ့ဂျ် ပို့၍ မရပါ',
      Constants.locale.aiResponseFailed: 'AI အဖြေကို ရယူ၍ မရပါ',
      Constants.locale.aiHistoryCleared: 'စကားဝိုင်းမှတ်တမ်း ရှင်းလင်းပြီးပါပြီ',
      Constants.locale.aiClearHistoryFailed: 'မှတ်တမ်း ရှင်းလင်း၍ မရပါ',
      Constants.locale.aiStartRecordingFailed: 'အသံဖမ်းခြင်း စတင်၍ မရပါ',
      Constants.locale.aiSaveRecordingFailed: 'အသံဖမ်းခြင်း သိမ်းဆည်း၍ မရပါ',
      Constants.locale.aiTranscriptionFailed: 'အသံကို စာသားမပြောင်း၍ ရပါ',
      Constants.locale.aiTranscriptionEmpty:
          'အသံမတွေ့ပါ။ ထပ်မံကြိုးစားပါ။',
      Constants.locale.aiTranscribing: 'စာသားပြောင်းနေသည်...',
      Constants.locale.aiTtsFailed: 'အသံဖွင့်၍ မရပါ',
      Constants.locale.aiTtsEmpty: 'ဖွင့်ရန် စာသားမရှိပါ',
    },
  };
}
